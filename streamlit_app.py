            ...
            if expected_ot > 0:
                ...
                for i, (col, _) in enumerate(volume_columns):
                    if st.session_state.ftes[i] > 0:
                        hours_needed = st.session_state.hours[i]
                        overtime_details.append((col, round(hours_needed, 2)))
                        total_ot_hours += hours_needed

                # Add total row
                overtime_details.append(("Total", round(total_ot_hours, 2)))
